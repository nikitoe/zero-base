...
public class 사무직원테스트 {
	...
	public static void main(String[] args) {
		...
		교직원 일잘하는교직원 = new 교직원("홍길삼", 1111 , "캠퍼스", 333333);
		
		사람 여자 = 일잘하는교직원;	//	 교직원 -> 사람 업 캐스팅
		...
		사무직원 열심히일하는사무직원 = new 사무직원("홀길풀", 4444, "패스트캠퍼스", 55555, "경영지원");
		사람 사람3 = 열심히일하는사무직원; // 사무직원 -> 사람 업 캐스팅
		교직원 교직원3 = 열심히일하는사무직원; // 사무직원 ->교직원 업 캐스팅 
